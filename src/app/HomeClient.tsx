...
interface HomeClientProps {
  ...
  initialCategoryData?: Record<string, { resources: Resource[], total: number }>;
}

export default function HomeClient({ initialResources = [], initialCategoryData = {} }: HomeClientProps) {
      ...
      <main className="flex-1 py-8">
        <Container>
          ...
          <div className="relative text-center mb-16 py-8">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold mb-6 bg-linear-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-300 bg-clip-text text-transparent font-[Montserrat]">
              发现最佳 AI 工具
            </h1>
          ...
          {isFiltering ? (
            ...
            <CategoryFeed initialData={initialCategoryData} />
          )}
        </Container>
      </main>
